/* "Lacquer" — the visual language of a nail colour swatch book.
   Deep aubergine ink, glossy lacquer chips, a condensed grotesque display.
   Deliberately NOT the cream-paper / high-contrast-serif / terracotta default. */
module.exports=`
:root{
 --ink:#150F1B; --ink-2:#221830; --paper:#FBF8F6; --line:#E6DEE6;
 --lacquer:#FF2E5B; --lacquer-d:#D4103B; --chrome:#B9A6CE; --gold:#C9A227;
 --mut:#6D6076; --mut-l:#A99FB2;
 --r:14px; --sp:clamp(18px,4vw,26px);
}
*{margin:0;padding:0;box-sizing:border-box}
html{scroll-behavior:smooth}
@media(prefers-reduced-motion:reduce){html{scroll-behavior:auto}*{animation:none!important;transition:none!important}}
body{background:var(--paper);color:var(--ink);font:17px/1.62 "Instrument Sans",-apple-system,system-ui,sans-serif;
 -webkit-font-smoothing:antialiased}
h1,h2,h3,h4,.brand,.stat b,.sr-n{font-family:"Bricolage Grotesque","Instrument Sans",sans-serif;font-weight:700;line-height:1.05;letter-spacing:-.02em}
...
/* ---- nav ---- */
.nav{background:var(--ink);color:#F3EEF6;position:sticky;top:0;z-index:20;
...
.brand:before{content:"";width:13px;height:22px;border-radius:7px 7px 5px 5px;flex:none;
 background:linear-gradient(150deg,#FF6B87 8%,var(--lacquer) 42%,var(--lacquer-d) 100%);
...
.lang summary{list-style:none;cursor:pointer;color:#DCD3E4;padding:4px 10px;border:1px solid #3B2F49;border-radius:99px}
...
.lang div{position:absolute;right:0;top:132%;background:#fff;border:1px solid var(--line);border-radius:12px;
 padding:7px;min-width:150px;box-shadow:0 18px 40px rgba(21,15,27,.22);z-index:30}
.lang div a{display:block;padding:8px 12px;border-radius:8px;color:var(--ink);font-size:14.5px}
.lang div a:hover{background:#F6F1F7;text-decoration:none}

/* ---- hero ---- */
.hero{background:var(--ink);color:#F6F2F8;padding:clamp(52px,8vw,86px) 0 clamp(46px,7vw,72px);position:relative;overflow:hidden}
.hero:after{content:"";position:absolute;inset:0;pointer-events:none;
 background:radial-gradient(58% 78% at 88% 4%,rgba(255,46,91,.26),transparent 62%),
            radial-gradient(46% 62% at 4% 96%,rgba(185,166,206,.2),transparent 66%)}
.hero .wrap{position:relative;z-index:1}
.hero h1{color:#fff;max-width:16ch}
.hero .lede{color:#CFC4D8;font-size:clamp(17px,2vw,20px);max-width:56ch;margin-top:18px}
...
.hero .eyebrow{color:#FF7A94}
/* signature: the swatch strip */
.swatch{display:flex;gap:7px;margin:26px 0 0}
.swatch i{width:34px;height:52px;border-radius:8px 8px 6px 6px;display:block;
 box-shadow:inset 2px 3px 0 rgba(255,255,255,.42),0 8px 20px rgba(0,0,0,.3)}
...
/* ---- editorial pick ---- */
.pick{background:var(--ink);color:#F3EEF6;border-radius:20px;margin:34px 0;overflow:hidden;
...
.pick h3 a{color:#fff}
.pick-m{color:#B8ABC4;font-size:14.5px;margin:0 0 12px}
.pick-t{color:#DCD3E4;max-width:52ch;font-size:15.5px}
.pick .rating b{color:#fff;font-size:19px}
.pick .st{color:var(--gold);letter-spacing:1px}
.pick .rc{color:#B8ABC4}
.pick-p{margin:0}
...
.biz-map{border-radius:var(--r);overflow:hidden;border:1px solid var(--line);background:#EFE9F0;min-height:270px}
...
table.data th{background:var(--ink);color:#F3EEF6;text-align:left;padding:12px 16px;font-family:"Bricolage Grotesque",sans-serif;font-weight:600}
...
.note{background:#FFF1F4;border-left:3px solid var(--lacquer);border-radius:0 12px 12px 0;padding:17px 21px;margin:22px 0;font-size:15.5px}
...
/* ---- footer ---- */
.foot{background:var(--ink);color:#B8ABC4;margin-top:76px;padding:48px 0 44px;font-size:14.5px}
.foot a{color:#DCD3E4}
.kwf{display:grid;grid-template-columns:repeat(auto-fit,minmax(190px,1fr));gap:26px;
 padding-bottom:32px;border-bottom:1px solid #2F2440}
.kwf h4{color:#8E80A0;margin-bottom:11px}
.kwf ul{list-style:none;font-size:14px}
.kwf li{margin:.36em 0}
.foot-b{padding-top:26px}
.foot .fine{color:#8E80A0;font-size:13px;max-width:82ch}
...
.foot-reach{font-size:14px;max-width:82ch;margin-bottom:14px;padding-bottom:14px;border-bottom:1px solid #2F2440}
.foot-reach a{color:#C9B6E0;text-decoration:underline;text-underline-offset:2px}
.credit{color:#7B6E8C;font-size:12.5px;margin-top:12px;max-width:82ch}
.credit a{color:#8E80A0}
...
.ed-p{margin:0;border-radius:var(--r);overflow:hidden;border:1px solid var(--line)}
...
.disclose{font-size:12.5px;color:var(--ink2,#6b6570);margin:10px 0 0;letter-spacing:.01em}
...
.gp{margin:0;border-radius:var(--r);overflow:hidden;border:1px solid var(--line);background:#fff}
...
.rev{background:#fff;border:1px solid var(--line);border-radius:var(--r);padding:22px;margin:0;font-size:15.5px}
.rev p{margin:0}
...
.ans{background:var(--ink);color:#F3EEF6;border-radius:var(--r);padding:26px 30px;margin:26px 0 30px}
...
.bl-i{display:grid;grid-template-columns:52px 1fr 168px;gap:20px;align-items:start;
 background:#fff;border:1px solid var(--line);border-radius:var(--r);padding:22px;margin:0 0 14px}
.bl-i.is-pick{border-color:var(--lacquer);box-shadow:0 0 0 1px var(--lacquer)}
.bl-n{font-family:"Bricolage Grotesque",serif;font-size:30px;color:var(--mut-l);line-height:1;text-align:center}
